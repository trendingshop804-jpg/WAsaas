...
class SettingsIntegrationsComponent {
  ...
  _cardHTML(ig) {
    ...
    const oauthSection = ig.type === 'oauth' && !isConnected ? (
      ...
      <div style="display: flex; flex-direction: column; gap: 8px;">
        ...
        <button type="button" class="btn btn-secondary btn-sm" id="btn-manual-${ig.id}" style="border-color: rgba(139, 92, 246, 0.4); color: #c4b5fd; width: 100%; justify-content: center; font-size: 12px;">
  ...
  _bindCardEvents() {
    this.integrations.forEach(ig => {
      ...
      document.getElementById(`btn-manual-${ig.id}`)?.addEventListener('click', () => {
        this._openInstagramManualModal();
      });
