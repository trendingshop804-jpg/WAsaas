...
/* ---- Tasks ---- */
NB.tasks = [
  { title:'Call Alice Green re: proposal',           time:'2:00 PM', priority:'High',   done:false },
  { title:'Send follow-up email to Bob Johnson',     time:'3:00 PM', priority:'Medium', done:false },
  { title:'Update CRM stages for Q4',                time:'4:00 PM', priority:'Low',    done:true  },
  { title:'Review pipeline report',                  time:'5:00 PM', priority:'Medium', done:false },
  { title:'Schedule onboarding for Priya Sharma',    time:'EOD',     priority:'High',   done:false },
  { title:'Complete activity log for Diana Lee',     time:'EOD',     priority:'Low',    done:true  },
];

/* ---- Activity ---- */
NB.activityFeed = [
  { icon:'user-plus',  color:'blue',   text:'New lead received',       sub:'Alice Green · 2 min ago'    },
  { icon:'phone',      color:'green',  text:'Call completed',          sub:'Bob Johnson · 1 hour ago'   },
  { icon:'message-circle', color:'purple', text:'New WhatsApp message', sub:'Charlie Davis · 2 hours ago' },
  { icon:'briefcase',  color:'orange', text:'Deal updated',            sub:'ERP Software · 3 hours ago' },
  { icon:'calendar',   color:'teal',   text:'Appointment scheduled',   sub:'Diana Lee · 5 hours ago'    },
];
