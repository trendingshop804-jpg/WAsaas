  ...
  organizations: [
    {
      ...
      // process exists in Node but not in a browser. Keep demo mode usable
      // without exposing or requiring a real WhatsApp access token.
      whatsappToken: typeof process !== 'undefined' && process.env ? process.env.TOKEN || '' : '',
